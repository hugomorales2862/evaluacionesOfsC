...
xajax_Grabar_borrador(evaluacion,linea,destino,autoevaluado,inmediato,eva_final,codigo_arma1,codigo_grado1,empleo1,tiempo1,codigo_arma2,codigo_grado2,empleo2,tiempo2,codigo_arma3,codigo_grado3,empleo3,tiempo3,puesto_ant,dep,renglon,tipo_evaluacion);
	...
	<form accept-charset="UTF-8">
		...
		<input type='hidden' name='tipo_evaluacion' id='tipo_evaluacion' value='16'></input> <!--el TIPO 16 == borrador, 17 es evaluado, 18 aprobado-->
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td colspan='2'><center><strong><small>EMPLEO ACTUAL Y UNIDAD<br><br></small></strong><input type="text" id='empleo1' name='empleo1' class='span5' value='<?php echo $empleo; ?>' onkeyup='mayusculas(this);'></input></center></td>
