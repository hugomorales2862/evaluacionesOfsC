...
==================================================================================================================================================-->
			...
			<div class='row-fluid'>
				<div class = 'span12' align='center'>
					<font size=5><b>OFICIALES PENDIENTES DE INICIAR PROCESO DE EVALUACION <br> PERIODO <?php echo $comp_eva; ?></b></font>
				</div>
			</div><br>
				<?php 
					echo tabla_faltan($dependencia,$comp_eva); 
				?>
			</div>
		</div>
