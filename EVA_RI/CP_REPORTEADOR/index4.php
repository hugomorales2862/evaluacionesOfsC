...
function Guardar(){
   // 	alert('Dios es amor y paz');
    ...
    // alert(dep);
      ...
      // alert(alumnos);
	var	alumnas = document.getElementById("alumnas").value;
      // alert(alumnas);
    

     xajax_guardar_alumnos(dep,alumnos,alumnas);
		...
		<form name='f1' id='f1'  method='post'>
			...
			<!--===============================INICIA EL FIELDSET======================================-->
				<fieldset style='background:#FAFAFA'>
					<legend align='left'> <h3>INGRESE EL ESTADO DE FUERZA DEL PERSONAL DE DAMAS Y CABALLEROS ALUMNOS</h3></legend>
	<!--====================================================================================================================================================-->
				...
				<tr>
					...
					<td>
						<div id="contEncCol" style="width:530px">
							<table id="encCol" >
								<tr>
									<td colspan = "3" align="center" style="width:111px;"><input  readonly value = "DAMAS Y CABALLEROS ALUMNOS" 	size = "11" style ="height:22px;align:middle" /></td>
					...
					<td>
						<div id="contEncFil" style="height:120px;">
							<table id="encFil" style="height:360px;">
								<tr><td height="22px"><input style="height:19px;" readonly id = "1"  name = "1" value = "ALUMNOS" 			size = "10" style ="height:22px;align:middle" title = "Personal Disponible: Referente al Personal que no se encuentra tomado en cuenta en los demas destinos" ></td></tr>
					...
					<td >
						<div id="contenedor" onscroll="desplaza()" style="width:530px;height:175px;">
							<table id="contenido" style="width:130px;height:260px;">
								<tr>
									<td height="13px"><input id = "alumnos"  name = "alumnos"       type= "text"  maxlength="3"  value = "0" size = "4"  onchange="sumaFila('1',14);sumaCol('1',11);"  onkeyup = "verif(this)" ></td>
									<td height="13px"><input id = "alumnas"  name = "alumnas"      type= "text" maxlength="3"  value = "0" size = "4"  onchange="sumaFila('1',14);sumaCol('2',11);"  onkeyup = "verif(this)" ></td>
	...
	<!--====================================================================================================================================================-->
					...
					<div class='row-fluid'>
						...
						<div class='span1'>
							...
							<input class="btn btn-success" type="button" title="GUARDAR" value="GUARDAR"  onclick="Guardar();"/></a>
						</div>
						<div class='span1'>
