...
<html>
	<head>
		...
		function Buscar(){
			...
			// alert(catalogo);
				if(catalogo != ""){
					xajax_Buscar_catalogo(catalogo,periodo);
				}else{
					alert("DEBE AGREGAR CATALOGO");
				}
		}
...
==================================================================================================================================================-->
	...
	<div align='center' class='container'>
			...
			<!--===============================INICIA EL FIELDSET======================================-->
				<fieldset style='background:#FAFAFA'>
					<legend align='left'> <h3>Reporte por catalogo</h3></legend>
	<!--====================================================================================================================================================-->
	...
	<!--====================================================================================================================================================-->
					<div class='row-fluid'>
						...
						<div class='span1'>
							<input class="btn btn-primary" type="button" title="Buscar" value="Buscar" onclick="Buscar(1);" />
						</div>
					</div>
					<br><br>
					<div id='resultado'>
