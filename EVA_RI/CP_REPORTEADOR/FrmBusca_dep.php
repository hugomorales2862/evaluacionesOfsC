...
<html>
	<head>
		...
		// alert(tipo);
			if (tipo == 1){
				form.action = "../CP_REP/REP_dep.php";
			}else{
...
==================================================================================================================================================-->
	...
	<div align='center' class='container'>
			...
			<!--===============================INICIA EL FIELDSET======================================-->
				<fieldset style='background:#FAFAFA'>
					<legend align='left'> <h3>Reporte por dependencias</h3></legend>
	<!--====================================================================================================================================================-->
	...
	<!--====================================================================================================================================================-->
					<div class='row-fluid'>
						...
						<div class='span1'>
							<input class="btn btn-primary" type="button" title="Buscar" value="Buscar" onclick="enviar_solicitud(1);" />
						</div>
					</div>
					<br><br>
					<div id='resultado'>
