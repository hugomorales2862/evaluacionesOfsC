...
function Guardar1(){
  ...
  //   alert(dep);
 	 var	reservistah = document.getElementById("reservistah").value;
    //   alert(reservistah);
	 var	reservistam = document.getElementById("reservistam").value;
    //   alert(reservistam);
    

     xajax_guardar_reservistas(dep,reservistah,reservistam);
		...
		<form name='f1' id='f1'  method='post'>
			...
			<!--===============================INICIA EL FIELDSET======================================-->
				<fieldset style='background:#FAFAFA'>
					<legend align='left'> <h3>INGRESE EL ESTADO DE FUERZA DEL PERSONAL DE RESERVISTAS</h3></legend>
	<!--====================================================================================================================================================-->
				...
				<tr>
					...
					<td>
						<div id="contEncCol" style="width:530px">
							<table id="encCol" >
								<tr>
									<td colspan = "3" align="center" style="width:111px;"><input  readonly value = "PERSONAL DE RESERVISTAS" 	size = "11" style ="height:22px;align:middle" /></td>
					...
					<td>
						<div id="contEncFil" style="height:120px;">
							<table id="encFil" style="height:360px;">
								<tr><td height="22px"><input style="height:19px;" readonly id = "1"  name = "1" value = "RESERVISTAS" 			size = "10" style ="height:22px;align:middle" title = "Personal Disponible: Referente al Personal que no se encuentra tomado en cuenta en los demas destinos" ></td></tr>
					...
					<td >
						<div id="contenedor" onscroll="desplaza()" style="width:530px;height:175px;">
							<table id="contenido" style="width:130px;height:260px;">
								<tr>
									<td height="13px"><input id = "reservistah"  name = "reservistah"       type= "text"  maxlength="3"  value = "0" size = "4"  onchange="sumaFila('1',14);sumaCol('1',11);"  onkeyup = "verif(this)" ></td>
									<td height="13px"><input id = "reservistam"  name = "reservistam"      type= "text" maxlength="3"  value = "0" size = "4"  onchange="sumaFila('1',14);sumaCol('2',11);"  onkeyup = "verif(this)" ></td>
	...
	<!--====================================================================================================================================================-->
					...
					<div class='row-fluid'>
						...
						<div class='span1'>
							...
							<input class="btn btn-success" type="button" title="GUARDAR" value="GUARDAR"  onclick="Guardar1();"/></a>
						</div>
						<div class='span1'>
