...
<script type='text/JavaScript'>
	function pageprint(){
		...
		<div align = "center" id = "print">
			<div class="btn-group">
				<center>
					<a class="btn btn-info" href="../CP_UL/Frm_ul.php" class="btn btn-info btn-lg">
...
<div class='container'><br>
		<table width='100%' border='1' >
			...
			<td><center><strong><small><font face="courier" size='2'>DESTINO ACTUAL</font><br></strong><font face="courier" size='1'><?php $destino = $ClsPer->trae_destinos($dest); echo $destino;?></font></small></center></td>
			</tr>
			<tr>
