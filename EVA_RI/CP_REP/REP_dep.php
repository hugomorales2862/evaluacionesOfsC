...
<script type='text/JavaScript'>
	function pageprint(){
		...
		<div align = "center" id = "print">
			<div class="btn-group">
				<center>
					<a class="btn btn-info" href="../CP_REPORTEADOR/FrmBusca_dep.php" class="btn btn-info btn-lg">
		...
		<table style = "width:100%">
			<tr>
				<td style = "width:70%;border:none;">
					<h4 align='center'><font size="2">REPORTE POR DEPENDENCIA</font></h4>
				</td>
			</tr>
		</table>
		<?php echo tabla_dep($dependencia,$periodo,$reporte); ?>
