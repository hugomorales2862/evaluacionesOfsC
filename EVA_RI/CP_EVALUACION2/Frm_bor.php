...
xajax_Grabar_borrador(evaluacion,linea,destino,autoevaluado,inmediato,eva_final,codigo_arma1,codigo_grado1,empleo1,tiempo1,codigo_arma2,codigo_grado2,empleo2,tiempo2,codigo_arma3,codigo_grado3,empleo3,tiempo3,puesto_ant,dep,renglon,tipo_evaluacion);
		...
		function mayusculas(n){
				...
				if(band == true){
					alert("No se permiten ingresar comillas simples o dobles, ni letras con tildes u otro caracter desconocido...");
				}
				n.value = cadena;
				n.focus();	
		}
	...
	<form accept-charset="UTF-8">
		...
		<div class='row-fluid'>
		<div class='span2'>
		<P class='pull-left'><smallint>AUTOEVALUACION</smallint></P>
		</div>
		...
		<input type='hidden' name='tipo_evaluacion' id='tipo_evaluacion' value='10'></input> <!--el TIPO 10 == borrador, 4 es autoevaluacion Y inmediato-->
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td colspan='2'><center><strong><small>EMPLEO ACTUAL Y UNIDAD<br><br></small></strong><input type="text" id='empleo1' name='destino' class='span3' value='<?php echo $empleo; ?>' onkeyup='mayusculas(this);'></input></center></td>
			<td><center><strong><small>TIEMPO EN EL EMPLEO ACTUAL<br></small></strong><input type="text" id='tiempo1' name='destino' class='span2' value='<?php echo $t_pue; ?>' onkeyup='mayusculas(this);'></input></small></strong></center></td>
			<td><center><strong><small>EMPLEO ANTERIOR<br><br></small></strong><input type="text" id='puesto_ant' name='destino' class='span3' value='<?php if ($puesto_ant != ""){ echo $puesto_ant; }else{ $puesto_ant = "DESCONOCIDO"; echo $puesto_ant;}?>' onkeyup='mayusculas(this);'></input></center></td>
			...
			<tr>
			<td colspan='2'><center><strong><small>GRADO Y NOMBRE DEL EVALUADOR INMEDIATO</small></strong><br><input type='text' class='span2' id='nombre_inmediato' placeholder='Evaluador inmediato'></input><?php echo combo_grados2(); ?></input><input type='hidden' name='codigo_arma2' id='codigo_arma2' value=''></input></center></td>
			...
			<td><center><strong><small>TIEMPO EN EL EMPLEO</small></strong><br><input type='text' class='span2' id='tiempo2' placeholder='Tiempo/Puesto' value='' onkeyup='mayusculas(this);'></input></center></td>
			</tr>
			<tr>
			<td colspan='2'><center><strong><small>GRADO Y NOMBRE DEL EVALUADOR FINAL</small></strong><br><?php echo $nombresub1; ?><input type='hidden' name='codigo_grado3' id='codigo_grado3' value='<?php echo $codigo_grado1sub; ?>'></input><input type='hidden' name='codigo_arma3' id='codigo_arma3' value='<?php echo $codigo_arma1sub; ?>'></input></center></td>
			<td><center><strong><small>CATALOGO</small></strong><br><?php echo $catalogo_sub; ?><input type="hidden" id='eva_final' onblur='trae_usuario(2);' name='eva_final' class='span2' value = '<?php echo $catalogo_sub; ?>' placeholder='Catalogo...' maxlength='6' onkeypress="return justNumbers(event);" readonly></input></center></td>
			<td><center><strong><small>EMPLEO</small></strong><br><?php echo $empleosub; ?><input type='hidden' class='span2' id='empleo3' placeholder='Empleo' value='<?php echo $empleosub; ?>' onkeyup='mayusculas(this);' readonly></input></center></td>
			<td><center><strong><small>TIEMPO EN EL EMPLEO</small></strong><br><input type='text' class='span2' id='tiempo3' placeholder='Tiempo/Puesto' value='<?php echo $t_puesub; ?>' onkeyup='mayusculas(this);'></input></center></td>
			</tr>
		</table>
		</table><br><br>
		<div align="center">
			&#32;<input class="btn btn-warning span3" type="reset" title="Limpiar" value="LIMPIAR BORRADOR" />
			&#32;<input class="btn btn-primary span3" type="button" title="Grabar" value="GRABAR BORRADOR" onclick="Grabar_formulario1();"/> <!--onclick="Grabar_formulario();"-->
			</div>
		</form>
	</form>
		<div class="footer">
