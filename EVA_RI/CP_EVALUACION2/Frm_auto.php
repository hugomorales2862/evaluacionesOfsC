		...
		<div id="container" align='center'>
			<div class='row-fluid'>
				<div class = 'span12' align='center'>
					<font size=5><b>Autoevaluaciones</font><br> <font size=3>Evaluan 2dos Comandantes/ Comandantes de Fuerza</font> <br><br> PERIODO: <?php echo $comp_eva; ?></b></font>
				</div>
			</div><br><br>
<!--==============================================================================================================================================
...
=================================================================================================================================================-->
					<?php 
					echo tabla_inmediato($dependencia,$comp_eva); 
					?>
				</form><br><br>
			</div>
		</div>
