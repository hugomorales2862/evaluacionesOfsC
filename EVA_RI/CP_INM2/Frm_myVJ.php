...
<html>
	...
	<form accept-charset="UTF-8">
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td colspan='5'><strong><small><?php echo utf8_encode('PARTE')?></small></strong></td>
			<tr bgcolor="#F5F5DC">
			...
			<td><center><input type="radio" name="pregunta6" id="pregio" name="pregunta6" id="pregunta6" value="5"></center></td>
