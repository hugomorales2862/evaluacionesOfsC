...
xajax_Grabar_borrador(evaluacion,linea,destino,autoevaluado,inmediato,eva_final,codigo_arma1,codigo_grado1,empleo1,tiempo1,codigo_arma2,codigo_grado2,empleo2,tiempo2,codigo_arma3,codigo_grado3,empleo3,tiempo3,puesto_ant,dep,renglon,tipo_evaluacion);
	...
	<form accept-charset="UTF-8">
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td colspan='2'><center><strong><small>EMPLEO ACTUAL Y UNIDAD<br><br></small></strong><input type="text" id='empleo1' name='destino' class='span4' value='<?php echo $empleo; ?>' onkeyup='mayusculas(this);'></input></center></td>
			...
			<td><center><strong><small>TIEMPO EN EL EMPLEO</small></strong><br><?php echo $t_puesub; ?><input type='hidden' class='span2' id='tiempo3' placeholder='Tiempo/Puesto' value='<?php echo $t_puesub; ?>' onkeyup='mayusculas(this);' readonly></input></center></td>
			</tr>
		</table>
		</table><br><br>
		<div align="center">
