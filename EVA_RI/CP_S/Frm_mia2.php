...
<html>
	<head>
		...
		function Grabar_formulario(){
			...
			if(cod_eva != "") {
					xajax_Grabar_evaluacion2(cod_eva,tipo_evaluacion,preguntas,usuario,obs_inmediato,obs_final,obs);
			}else{
				alert("Ocurrio un error de conexion");
				window.location.assign("../CP_S/Frm_inmediato.php");
			}
		}
		...
		function CloseWindow(num){
			if(num == 1){
				window.location.assign("../CP_S/Frm_auto.php");
			}else{
	...
	<form accept-charset="UTF-8">
		...
		<table width='100%' border='1' >
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>PRODUCCION Y CALIDAD DE TRABAJO:</b><br>Cantidad y calidad de trabajo ejecutado a nivel de excelencia buscando dar lo mejor de si mismo.</td>
			<td><center><input type="radio" name="pregunta21" id="pregunta21" value="5"></center></td>
			<td><center><input type="radio" name="pregunta21" id="pregunta21" value="3"></center></td>
			<td><center><input type="radio" name="pregunta21" id="pregunta21" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>CONOCIMIENTO DEL EMPLEO:</b><br>Nivel de conocimiento del empleo por medio de la experiencia, educacion, capacitacion y entrenamiento.</td>
			<td><center><input type="radio" name="pregunta22" id="pregunta22" value="5"></center></td>
			<td><center><input type="radio" name="pregunta22" id="pregunta22" value="3"></center></td>
			<td><center><input type="radio" name="pregunta22" id="pregunta22" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>TRABAJO EN EQUIPO:</b><br>Capacidad de integrarse a un grupo y aportar sus capacidades y habilidades para lograr cumplir objetivos y metas.</td>
			<td><center><input type="radio" name="pregunta23" id="pregunta23" value="5"></center></td>
			<td><center><input type="radio" name="pregunta23" id="pregunta23" value="3"></center></td>
			<td><center><input type="radio" name="pregunta23" id="pregunta23" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>TRABAJO BAJO PRESION:</b><br>Capacidad para responder en situaciones de presion o tension en el trabajo, para cumplir las tareas y responsabilidades encomendadas eficaz y eficientemente.</td>
			<td><center><input type="radio" name="pregunta24" id="pregunta24" value="5"></center></td>
			<td><center><input type="radio" name="pregunta24" id="pregunta24" value="3"></center></td>
			<td><center><input type="radio" name="pregunta24" id="pregunta24" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>PUNTUALIDAD:</b><br>Es la antelacion y preparacion en el cumplimiento de sus labores.</td>
			<td><center><input type="radio" name="pregunta25" id="pregunta25" value="5"></center></td>
			<td><center><input type="radio" name="pregunta25" id="pregunta25" value="3"></center></td>
			<td><center><input type="radio" name="pregunta25" id="pregunta25" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td colspan='5'><center><strong><small>CAPACIDADES ADMINISTRATIVAS<br>Habilidad que facilita la administracion de los recursos en el ejercicio de sus funciones.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>ADMINISTRACION DE RECURSOS:</b><br>Capacidad de desarrollar el proceso de planear, organizar, dirigir y controlar el uso de los recursos con eficiencia y eficacia para cumplir con las tareas establecidas.</td>
			<td><center><input type="radio" name="pregunta26" id="pregunta26" value="5"></center></td>
			<td><center><input type="radio" name="pregunta26" id="pregunta26" value="3"></center></td>
			<td><center><input type="radio" name="pregunta26" id="pregunta26" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>COOPERACION:</b><br>Actitud hacia la institucion, la autoridad, los compa&ntilde;eros de trabajo y subalternos buscando realizar un trabajo en equipo enfocado en la vision y mision.</td>
			<td><center><input type="radio" name="pregunta27" id="pregunta27" value="5"></center></td>
			<td><center><input type="radio" name="pregunta27" id="pregunta27" value="3"></center></td>
			<td><center><input type="radio" name="pregunta27" id="pregunta27" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>SUPERVISION:</b><br>Accion positiva que se ejerce para controlar el fiel cumplimiento de las ordenes misiones y tareas asignadas.</td>
			<td><center><input type="radio" name="pregunta28" id="pregunta28" value="5"></center></td>
			<td><center><input type="radio" name="pregunta28" id="pregunta28" value="3"></center></td>
			<td><center><input type="radio" name="pregunta28" id="pregunta28" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>DESTREZA:</b><br>Capacidad en el manejo y conocimiento de los instrumentos de trabajo.</td>
			<td><center><input type="radio" name="pregunta29" id="pregunta29" value="5"></center></td>
			<td><center><input type="radio" name="pregunta29" id="pregunta29" value="3"></center></td>
			<td><center><input type="radio" name="pregunta29" id="pregunta29" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>EJECUCION:</b><br>Capacidad de llevar a cabo las ordenes y cumplir los objetivos que se le dan sin equivocarse al seguir instrucciones, basado en la mistica militar y vocacion.</td>
			<td><center><input type="radio" name="pregunta30" id="pregunta30" value="5"></center></td>
			<td><center><input type="radio" name="pregunta30" id="pregunta30" value="3"></center></td>
			<td><center><input type="radio" name="pregunta30" id="pregunta30" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td colspan='5'><center><strong><small>APTITUDES MILITARES<br>Capacidad para realizar las funciones y tareas especificas en el servicio militar.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>INICIATIVA:</b><br>Aporte y desarrollo de ideas creativas y constructivas para solucion de situaciones imprevistas.</td>
			<td><center><input type="radio" name="pregunta31" id="pregunta31" value="5"></center></td>
			<td><center><input type="radio" name="pregunta31" id="pregunta31" value="3"></center></td>
			<td><center><input type="radio" name="pregunta31" id="pregunta31" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>ABNEGACION:</b><br>Aptitud consistente en el sacrificio espontaneo de la voluntad, interes, deseos y aun de la propia vida, en cumplimiento de la mision.</td>
			<td><center><input type="radio" name="pregunta32" id="pregunta32" value="5"></center></td>
			<td><center><input type="radio" name="pregunta32" id="pregunta32" value="3"></center></td>
			<td><center><input type="radio" name="pregunta32" id="pregunta32" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>PORTE:</b><br>Capacidad de presentacion personal, en comportamiento y apariencia, coincidentes con las normas militares y sociales.</td>
			<td><center><input type="radio" name="pregunta33" id="pregunta33" value="5"></center></td>
			<td><center><input type="radio" name="pregunta33" id="pregunta33" value="3"></center></td>
			<td><center><input type="radio" name="pregunta33" id="pregunta33" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>LIDERAZGO:</b><br>Habilidad de persuadir y dirigir al personal subalterno, de tal manera que se obtenga su obediencia, confianza, el respeto, lealtad, cooperacion voluntaria con el fin de cumplir la mision.</td>
			<td><center><input type="radio" name="pregunta34" id="pregunta34" value="5"></center></td>
			<td><center><input type="radio" name="pregunta34" id="pregunta34" value="3"></center></td>
			<td><center><input type="radio" name="pregunta34" id="pregunta34" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>ESPIRITU DE CUERPO:</b><br>Es lealtad, orgullo y entusiasmo que sienten los individuos de pertenecer a su unidad.</td>
			<td><center><input type="radio" name="pregunta35" id="pregunta35" value="5"></center></td>
			<td><center><input type="radio" name="pregunta35" id="pregunta35" value="3"></center></td>
			<td><center><input type="radio" name="pregunta35" id="pregunta35" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td colspan='5'><center><strong><small>CUALIDADES PERSONALES<br>Caracteristicas individuales necesarias para el buen desempeño del puesto.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>TOMA DE DECISIONES:</b><br>Capacidad de resolucion definitiva y oportuna a problemas asociados al ejercicio de sus funciones con juicio y criterio, sin rehuir responsabilidades asociadas a la decision.</td>
			<td><center><input type="radio" name="pregunta36" id="pregunta36" value="5"></center></td>
			<td><center><input type="radio" name="pregunta36" id="pregunta36" value="3"></center></td>
			<td><center><input type="radio" name="pregunta36" id="pregunta36" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>RELACIONES INTERPERSONALES:</b><br>Considera el trato, respeto y comunicacion hacia superiores, subalternos y compa&ntilde;eros.</td>
			<td><center><input type="radio" name="pregunta37" id="pregunta37" value="5"></center></td>
			<td><center><input type="radio" name="pregunta37" id="pregunta37" value="3"></center></td>
			<td><center><input type="radio" name="pregunta37" id="pregunta37" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>RESPONSABILIDAD:</b><br>Capacidad para cumplir las tareas y responsabilidades inherentes al grado y funcion, con dedicacion, puntualidad y observando los plazos establecidos.</td>
			<td><center><input type="radio" name="pregunta38" id="pregunta38" value="5"></center></td>
			<td><center><input type="radio" name="pregunta38" id="pregunta38" value="3"></center></td>
			<td><center><input type="radio" name="pregunta38" id="pregunta38" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>COMPROMISO:</b><br>Poner al maximo su capacidad para sacar toda tarea que le sea confiada con dedicacion y esmero.</td>
			<td><center><input type="radio" name="pregunta39" id="pregunta39" value="5"></center></td>
			<td><center><input type="radio" name="pregunta39" id="pregunta39" value="3"></center></td>
			<td><center><input type="radio" name="pregunta39" id="pregunta39" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#CEECF5">
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>CRITERIO:</b><br>Facultad que se tiene para comprender algo o formar una opinion.</td>
			<td><center><input type="radio" name="pregunta40" id="pregunta40" value="5"></center></td>
			<td><center><input type="radio" name="pregunta40" id="pregunta40" value="3"></center></td>
			<td><center><input type="radio" name="pregunta40" id="pregunta40" value="1" checked></center></td>
			</tr>
			<?php }else if($renglon == 2 or $renglon == 3){ ?>
			<tr bgcolor="#CEECF5">
			<td colspan='5'><center><strong><small>DESEMPE&Ntilde;O LABORAL<br>Habilidades y cualidades  de la persona que se califican a traves de las funciones y tareas.</small></strong></center></td>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>PRODUCCION Y CALIDAD DE TRABAJO:</b><br>Cantidad y calidad de trabajo ejecutado a nivel de excelencia buscando dar lo mejor de si mismo.</td>
			<td><center><input type="radio" name="pregunta41" id="pregunta41" value="5"></center></td>
			<td><center><input type="radio" name="pregunta41" id="pregunta41" value="3"></center></td>
			<td><center><input type="radio" name="pregunta41" id="pregunta41" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>CONOCIMIENTO DEL EMPLEO:</b><br>Nivel de conocimiento del empleo por medio de la experiencia, educacion, capacitacion y entrenamiento.</td>
			<td><center><input type="radio" name="pregunta42" id="pregunta42" value="5"></center></td>
			<td><center><input type="radio" name="pregunta42" id="pregunta42" value="3"></center></td>
			<td><center><input type="radio" name="pregunta42" id="pregunta42" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>TRABAJO EN EQUIPO:</b><br>Capacidad de integrarse a un grupo y aportar sus capacidades y habilidades para lograr cumplir objetivos y metas.</td>
			<td><center><input type="radio" name="pregunta43" id="pregunta43" value="5"></center></td>
			<td><center><input type="radio" name="pregunta43" id="pregunta43" value="3"></center></td>
			<td><center><input type="radio" name="pregunta43" id="pregunta43" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>TRABAJO BAJO PRESION:</b><br>Capacidad para responder en situaciones de presion o tension en el trabajo, para cumplir las tareas y responsabilidades encomendadas eficaz y eficientemente.</td>
			<td><center><input type="radio" name="pregunta44" id="pregunta44" value="5"></center></td>
			<td><center><input type="radio" name="pregunta44" id="pregunta44" value="3"></center></td>
			<td><center><input type="radio" name="pregunta44" id="pregunta44" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>PUNTUALIDAD:</b><br>Es la antelacion y preparacion en el cumplimiento de sus labores.</td>
			<td><center><input type="radio" name="pregunta45" id="pregunta45" value="5"></center></td>
			<td><center><input type="radio" name="pregunta45" id="pregunta45" value="3"></center></td>
			<td><center><input type="radio" name="pregunta45" id="pregunta45" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td colspan='5'><center><strong><small>CAPACIDADES ADMINISTRATIVAS<br>Habilidad que facilita la administracion de los recursos en el ejercicio de sus funciones.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>ADMINISTRACION DE RECURSOS:</b><br>Capacidad de desarrollar el proceso de planear, organizar, dirigir y controlar el uso de los recursos con eficiencia y eficacia para cumplir con las tareas establecidas.</td>
			<td><center><input type="radio" name="pregunta46" id="pregunta46" value="5"></center></td>
			<td><center><input type="radio" name="pregunta46" id="pregunta46" value="3"></center></td>
			<td><center><input type="radio" name="pregunta46" id="pregunta46" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>COOPERACION:</b><br>Actitud hacia la institucion, la autoridad, los compa&ntilde;eros de trabajo y subalternos buscando realizar un trabajo en equipo enfocado en la vision y mision.</td>
			<td><center><input type="radio" name="pregunta47" id="pregunta47" value="5"></center></td>
			<td><center><input type="radio" name="pregunta47" id="pregunta47" value="3"></center></td>
			<td><center><input type="radio" name="pregunta47" id="pregunta47" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>SUPERVISION:</b><br>Accion positiva que se ejerce para controlar el fiel cumplimiento de las ordenes misiones y tareas asignadas.</td>
			<td><center><input type="radio" name="pregunta48" id="pregunta48" value="5"></center></td>
			<td><center><input type="radio" name="pregunta48" id="pregunta48" value="3"></center></td>
			<td><center><input type="radio" name="pregunta48" id="pregunta48" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>DESTREZA:</b><br>Capacidad en el manejo y conocimiento de los instrumentos de trabajo.</td>
			<td><center><input type="radio" name="pregunta49" id="pregunta49" value="5"></center></td>
			<td><center><input type="radio" name="pregunta49" id="pregunta49" value="3"></center></td>
			<td><center><input type="radio" name="pregunta49" id="pregunta49" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>EJECUCION:</b><br>Capacidad de llevar a cabo las ordenes y cumplir los objetivos que se le dan sin equivocarse al seguir instrucciones, basado en la mistica militar y vocacion.</td>
			<td><center><input type="radio" name="pregunta50" id="pregunta50" value="5"></center></td>
			<td><center><input type="radio" name="pregunta50" id="pregunta50" value="3"></center></td>
			<td><center><input type="radio" name="pregunta50" id="pregunta50" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td colspan='5'><center><strong><small>APTITUDES MILITARES<br>Capacidad para realizar las funciones y tareas especificas en el servicio militar.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>INICIATIVA:</b><br>Aporte y desarrollo de ideas creativas y constructivas para solucion de situaciones imprevistas.</td>
			<td><center><input type="radio" name="pregunta51" id="pregunta51" value="5"></center></td>
			<td><center><input type="radio" name="pregunta51" id="pregunta51" value="3"></center></td>
			<td><center><input type="radio" name="pregunta51" id="pregunta51" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>ABNEGACION:</b><br>Aptitud consistente en el sacrificio espontaneo de la voluntad, interes, deseos y aun de la propia vida, en cumplimiento de la mision.</td>
			<td><center><input type="radio" name="pregunta52" id="pregunta52" value="5"></center></td>
			<td><center><input type="radio" name="pregunta52" id="pregunta52" value="3"></center></td>
			<td><center><input type="radio" name="pregunta52" id="pregunta52" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>PORTE:</b><br>Capacidad de presentacion personal, en comportamiento y apariencia, coincidentes con las normas militares y sociales.</td>
			<td><center><input type="radio" name="pregunta53" id="pregunta53" value="5"></center></td>
			<td><center><input type="radio" name="pregunta53" id="pregunta53" value="3"></center></td>
			<td><center><input type="radio" name="pregunta53" id="pregunta53" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>LIDERAZGO:</b><br>Habilidad de persuadir y dirigir al personal subalterno, de tal manera que se obtenga su obediencia, confianza, el respeto, lealtad, cooperacion voluntaria con el fin de cumplir la mision.</td>
			<td><center><input type="radio" name="pregunta54" id="pregunta54" value="5"></center></td>
			<td><center><input type="radio" name="pregunta54" id="pregunta54" value="3"></center></td>
			<td><center><input type="radio" name="pregunta54" id="pregunta54" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>ESPIRITU DE CUERPO:</b><br>Es lealtad, orgullo y entusiasmo que sienten los individuos de pertenecer a su unidad.</td>
			<td><center><input type="radio" name="pregunta55" id="pregunta55" value="5"></center></td>
			<td><center><input type="radio" name="pregunta55" id="pregunta55" value="3"></center></td>
			<td><center><input type="radio" name="pregunta55" id="pregunta55" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td colspan='5'><center><strong><small>CUALIDADES PERSONALES<br>Caracteristicas individuales necesarias para el buen desempeño del puesto.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>TOMA DE DECISIONES:</b><br>Capacidad de resolucion definitiva y oportuna a problemas asociados al ejercicio de sus funciones con juicio y criterio, sin rehuir responsabilidades asociadas a la decision.</td>
			<td><center><input type="radio" name="pregunta56" id="pregunta56" value="5"></center></td>
			<td><center><input type="radio" name="pregunta56" id="pregunta56" value="3"></center></td>
			<td><center><input type="radio" name="pregunta56" id="pregunta56" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>RELACIONES INTERPERSONALES:</b><br>Considera el trato, respeto y comunicacion hacia superiores, subalternos y compa&ntilde;eros.</td>
			<td><center><input type="radio" name="pregunta57" id="pregunta57" value="5"></center></td>
			<td><center><input type="radio" name="pregunta57" id="pregunta57" value="3"></center></td>
			<td><center><input type="radio" name="pregunta57" id="pregunta57" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>RESPONSABILIDAD:</b><br>Capacidad para cumplir las tareas y responsabilidades inherentes al grado y funcion, con dedicacion, puntualidad y observando los plazos establecidos.</td>
			<td><center><input type="radio" name="pregunta58" id="pregunta58" value="5"></center></td>
			<td><center><input type="radio" name="pregunta58" id="pregunta58" value="3"></center></td>
			<td><center><input type="radio" name="pregunta58" id="pregunta58" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>COMPROMISO:</b><br>Poner al maximo su capacidad para sacar toda tarea que le sea confiada con dedicacion y esmero.</td>
			<td><center><input type="radio" name="pregunta59" id="pregunta59" value="5"></center></td>
			<td><center><input type="radio" name="pregunta59" id="pregunta59" value="3"></center></td>
			<td><center><input type="radio" name="pregunta59" id="pregunta59" value="1" checked></center></td>
			</tr>
			<tr bgcolor="#F2F5A9">
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>CRITERIO:</b><br>Facultad que se tiene para comprender algo o formar una opinion.</td>
			<td><center><input type="radio" name="pregunta60" id="pregunta60" value="5"></center></td>
			<td><center><input type="radio" name="pregunta60" id="pregunta60" value="3"></center></td>
			<td><center><input type="radio" name="pregunta60" id="pregunta60" value="1" checked></center></td>
			</tr>
			<?php }else if($renglon == 2 or $renglon == 3){ ?>
			<tr bgcolor="#F2F5A9">
			<td colspan='5'><center><strong><small>DESEMPE&Ntilde;O LABORAL<br>Habilidades y cualidades  de la persona que se califican a traves de las funciones y tareas.</small></strong></center></td>
