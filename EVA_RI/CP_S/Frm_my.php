...
xajax_Grabar_evaluacion(evaluacion,linea,destino,autoevaluado,inmediato,eva_final,codigo_arma1,codigo_grado1,empleo1,tiempo1,codigo_arma2,codigo_grado2,empleo2,tiempo2,codigo_arma3,codigo_grado3,empleo3,tiempo3,puesto_ant,dep,renglon,obs_inmediato,obs_final,tipo_evaluacion,preguntas,usuario,obs);
	...
	<form accept-charset="UTF-8">
		...
		<table width='100%' border='1' >
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>PRODUCCION Y CALIDAD DE TRABAJO:</b><br>Cantidad y calidad de trabajo ejecutado a nivel de excelencia buscando dar lo mejor de si mismo.</td>
			<td><center><input type="radio" name="pregunta1" id="pregunta1" value="5"checked disabled></center></td>
			<td><center><input type="radio" name="pregunta1" id="pregunta1" value="3" disabled ></center></td>
			<td><center><input type="radio" name="pregunta1" id="pregunta1" value="1" disabled ></center></td>
			</tr>
			<tr>
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>CONOCIMIENTO DEL EMPLEO:</b><br>Nivel de conocimiento del empleo por medio de la experiencia, educacion, capacitacion y entrenamiento.</td>
			<td><center><input type="radio" name="pregunta2" id="pregunta2" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta2" id="pregunta2" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta2" id="pregunta2" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>TRABAJO EN EQUIPO:</b><br>Capacidad de integrarse a un grupo y aportar sus capacidades y habilidades para lograr cumplir objetivos y metas.</td>
			<td><center><input type="radio" name="pregunta3" id="pregunta3" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta3" id="pregunta3" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta3" id="pregunta3" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>TRABAJO BAJO PRESION:</b><br>Capacidad para responder en situaciones de presion o tension en el trabajo, para cumplir las tareas y responsabilidades encomendadas eficaz y eficientemente.</td>
			<td><center><input type="radio" name="pregunta4" id="pregunta4" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta4" id="pregunta4" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta4" id="pregunta4" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>PUNTUALIDAD:</b><br>Es la antelacion y preparacion en el cumplimiento de sus labores.</td>
			<td><center><input type="radio" name="pregunta5" id="pregunta5" value="5"checked disabled></center></td>
			<td><center><input type="radio" name="pregunta5" id="pregunta5" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta5" id="pregunta5" value="1" disabled></center></td>
			</tr>
			<tr>
			<td colspan='5'><center><strong><small>CAPACIDADES ADMINISTRATIVAS<br>Habilidad que facilita la administracion de los recursos en el ejercicio de sus funciones.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>ADMINISTRACION DE RECURSOS:</b><br>Capasidad de desarrollar el proceso de planear, organizar, dirigir y controlar el uso de los recursos con eficiencia y eficacia para cumplir con las tareas establecidas.</td>
			<td><center><input type="radio" name="pregunta6" id="pregunta6" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta6" id="pregunta6" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta6" id="pregunta6" value="1"disabled ></center></td>
			</tr>
			<tr>
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>COOPERACION:</b><br>Actitud hacia la institucion, la autoridad, los compa&ntilde;eros de trabajo y subalternos buscando realizar un trabajo en equipo enfocado en la vision y mision.</td>
			<td><center><input type="radio" name="pregunta7" id="pregunta7" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta7" id="pregunta7" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta7" id="pregunta7" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>SUPERVISION:</b><br>Accion positiva que se ejerce para controlar el fiel cumplimiento de las ordenes misiones y tareas asignadas.</td>
			<td><center><input type="radio" name="pregunta8" id="pregunta8" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta8" id="pregunta8" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta8" id="pregunta8" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>DESTREZA:</b><br>Capacidad en el manejo y conocimiento de los instrumentos de trabajo.</td>
			<td><center><input type="radio" name="pregunta9" id="pregunta9" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta9" id="pregunta9" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta9" id="pregunta9" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>EJECUCION:</b><br>Capacidad de llevbar a cabo las ordenes y cumplir los objetivos que se le dan sin equivocarse al seguir instrucciones, basado en la mistica militar y vocacion.</td>
			<td><center><input type="radio" name="pregunta10" id="pregunta10" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta10" id="pregunta10" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta10" id="pregunta10" value="1" disabled></center></td>
			</tr>
			<tr>
			<td colspan='5'><center><strong><small>APTITUDES MILITARES<br>Capacidad para realizar las funciones y tareas especificas en el servicio militar.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>INICIATIVA:</b><br>Aporte y desarrollo de ideas creativas y constructivas para solucion de situaciones imprevistas.</td>
			<td><center><input type="radio" name="pregunta11" id="pregunta11" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta11" id="pregunta11" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta11" id="pregunta11" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>ABNEGACION:</b><br>Aptitud consistente en el sacrificio espontaneo de la voluntad, interes, deseos y aun de la propia vida, en cumplimiento de la mision.</td>
			<td><center><input type="radio" name="pregunta12" id="pregunta12" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta12" id="pregunta12" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta12" id="pregunta12" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>PORTE:</b><br>Capacidad de presentacion personal, en comportamiento y apariencia, coincidentes con las normas militares y sociales.</td>
			<td><center><input type="radio" name="pregunta13" id="pregunta13" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta13" id="pregunta13" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta13" id="pregunta13" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>LIDERAZGO:</b><br>Habilidad de persuadir y dirigir al personal subalterno, de tal manera que se obtenga su obediencia, confianza, el respeto, lealtad, cooperacion voluntaria con el fin de cumplir la mision.</td>
			<td><center><input type="radio" name="pregunta14" id="pregunta14" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta14" id="pregunta14" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta14" id="pregunta14" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>ESPIRITU DE CUERPO:</b><br>Es lealtad, orgullo y entusiasmo que sienten los individuos de pertenecer a su unidad.</td>
			<td><center><input type="radio" name="pregunta15" id="pregunta15" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta15" id="pregunta15" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta15" id="pregunta15" value="1" disabled></center></td>
			</tr>
			<tr>
			<td colspan='5'><center><strong><small>CUALIDADES PERSONALES<br>Caracteristicas individuales necesarias para el buen desempeño del puesto.</small></strong></center></td>
			</tr>
			...
			<td><center><strong><small>1.</small></strong></center></td>
			<td><b>TOMA DE DECISIONES:</b><br>Capacidad de resolucion definitiva y oportuna a problemas asociados al ejercicio de sus funciones con juicio y criterio, sin rehuir responsabilidades asociadas a la decision.</td>
			<td><center><input type="radio" name="pregunta16" id="pregunta16" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta16" id="pregunta16" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta16" id="pregunta16" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>2.</small></strong></center></td>
			<td><b>RELACIONES INTERPERSONALES:</b><br>Considera el trato, respeto y comunicacion hacia superiores, subalternos y compa&ntilde;eros.</td>
			<td><center><input type="radio" name="pregunta17" id="pregunta17" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta17" id="pregunta17" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta17" id="pregunta17" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>RESPONSABILIDAD:</b><br>Capacidad para cumplir las tareas y responsabilidades inherentes al grado y funcion, con dedicacion, puntualidad y observando los plazos establecidos.</td>
			<td><center><input type="radio" name="pregunta18" id="pregunta18" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta18" id="pregunta18" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta18" id="pregunta18" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>4.</small></strong></center></td>
			<td><b>COMPROMISO:</b><br>Ponel al maximo su capacidad para sacar toda tarea que le sea confiada con dedicacion y esmero.</td>
			<td><center><input type="radio" name="pregunta19" id="pregunta19" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta19" id="pregunta19" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta19" id="pregunta19" value="1" disabled></center></td>
			</tr>
			<tr>
			<td><center><strong><small>5.</small></strong></center></td>
			<td><b>CRITERIO:</b><br>Facultad que se tiene para comprender algo o formar una opinion.</td>
			<td><center><input type="radio" name="pregunta20" id="pregunta20" value="5" checked disabled></center></td>
			<td><center><input type="radio" name="pregunta20" id="pregunta20" value="3" disabled></center></td>
			<td><center><input type="radio" name="pregunta20" id="pregunta20" value="1" disabled></center></td>
			</tr>
			<?php }?>
			</table>
			</td>
