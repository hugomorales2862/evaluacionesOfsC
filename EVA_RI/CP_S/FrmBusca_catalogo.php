			...
			<div class="container" bgcolor = "#B2C3E1">
				<table class='filas' align = "center" cellpadding="15px" border = '1' >
					...
					<form class="form-search" name='f1' id='f1' method='POST'>
						...
						<button type="button" class="btn btn-info" onclick ="enviar();">Buscar</button><BR>
						</td>
						</tr>
						<tr>
						<td bgcolor='#E3F6CE' align='center'>
							<input type='checkbox' id='check' name='check' value='' onclick='input();' />
							&nbsp&nbsp&nbsp Evalua SubJefe EMDN
						</tr>
					</form>
				</table>
			</div>
