		...
		if($result != ""){
			...
			foreach($result as $row){
				...
				if ($grado == 46 || $grado == 59 || $grado == 65 || $grado == 73 || $grado == 81 || $grado == 88 || $grado == 92 || $grado == 93 || $grado == 96 || $grado == 97 || $grado == 99 || $grado == 40){
					...
					if($situacion == 10){
						$salida.= "<td align = 'center'><a href = '../CP_S/Frm_mia.php?eva=".$eva_id."&sit=11'  onclick = '' type = 'button' class='btn btn-info' title = 'Evaluar'><i class='icon-user'></i></a></td>";
					}else{
						$salida.= "<td align = 'center'><a href = '../CP_S/Frm_mia2.php?eva=".$eva_id."&sit=15'  onclick = '' type = 'button' class='btn btn-info' title = 'Evaluar'><i class='icon-user'></i></a></td>";
					}
