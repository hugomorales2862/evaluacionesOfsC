		...
		<div id="container" align='center'>
			<div class='row-fluid'>
				<div class = 'span12' align='center'>
					<font size=5><b>Evaluadores Inmediatos </font><br> <font size=3>Evaluan Directores Ministeriales</font> <br><br> PERIODO: <?php echo $comp_eva; ?></b></font>
				</div>
			</div><br><br>
<!--==============================================================================================================================================
...
=================================================================================================================================================-->
					<?php 
					echo tabla_inmediato_DIR($dependencia,$comp_eva); 
					?>
				</form><br><br>
			</div>
		</div>
