...
empleo1,tiempo1,codigo_arma2,codigo_grado2,empleo2,tiempo2,codigo_arma3,codigo_grado3,empleo3,tiempo3,puesto_ant,dep,renglon,tipo_evaluacion);
	...
	<form accept-charset="UTF-8">
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td colspan='2'><center><strong><small>GRADO Y NOMBRE DEL EVALUADOR FINAL</small></strong><br><input type='text' class='span3' id='nombre_comte' placeholder='Evaluador final' value='<?php echo $nombre_fin; ?>' ></input><?php echo combo_grados3(); ?><input type='hidden' name='codigo_arma3' id='codigo_arma3' value=''></input></center></td>
		...
		<div align="center">
			<input type="button" onclick="location.href='../CP_EVALUACION/Frm_auto.php';"  class="btn btn-danger span3" value="CANCELAR" />
