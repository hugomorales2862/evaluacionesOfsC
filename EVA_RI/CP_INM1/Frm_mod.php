...
empleo1,tiempo1,codigo_arma2,codigo_grado2,empleo2,tiempo2,codigo_arma3,codigo_grado3,empleo3,tiempo3,puesto_ant,dep,renglon,tipo_evaluacion);
	...
	<form accept-charset="UTF-8">
		...
		<?php if($mes == 5 or $mes == 6 or $mes == 7 or $mes == 10){?>
			<div class='span2'>
				<input type = 'text' class='span12' name = 'periodo' id = 'periodo' value ='1 - <?php echo $annio; ?>' readonly></input> 
			</div>
		<?php }elseif($mes == 11 or $mes == 12 or $mes == 1){?>
			<div class='span2'>
				<input type = 'text' class='span12' name = 'periodo' id = 'periodo' value ='2 - <?php echo $annio; ?>' readonly></input> 
			</div>
		<?php }?>
		...
		<table width='100%' border='1' >
			...
			<td><center><strong><small>GRADO:<br><br></small></strong><?php echo combo_grados1($gra11); ?></center></td>
			...
			<tr>
			<td colspan='2'><center><strong><small>GRADO Y NOMBRE DEL EVALUADOR INMEDIATO</small></strong><br><input type='text' class='span3' id='nombre_inmediato' placeholder='Evaluador inmediato' value='<?php echo $nombre_inmediato; ?>'></input><?php echo combo_grados2($gra21); ?></input><input type='hidden' name='codigo_arma2' id='codigo_arma2' value=''></input></center></td>
			...
			<tr>
			<td colspan='2'><center><strong><small>GRADO Y NOMBRE DEL EVALUADOR FINAL</small></strong><br><input type='text' class='span3' id='nombre_comte' placeholder='Evaluador final' value='<?php echo $nombre_fin; ?>' ></input><?php echo combo_grados3($gra31); ?><input type='hidden' name='codigo_arma3' id='codigo_arma3' value=''></input></center></td>
