		...
		if($result != ""){
			...
			foreach($result as $row){
				...
				if ($cont % 2 == 0) {
					...
					$salida.= "<td align = 'center'><a href = '../CP_INM/Frm_my.php?eva=".$eva_id."&sit=3' onclick = '' type = 'button' class='btn btn-info' title = 'Evalua jefe final'><i class='icon-user'></i></a></td>";
