...
// ==================================================================================================================================================-->
	function tabla_inmediato($dependencia,$comp_eva){
		...
		if($result != ""){
			...
			$salida.= '<td width = "1px" 	align="center"><b>	EVALUAR</b></td>';
			...
			foreach($result as $row){
				...
				if ($cont % 2 == 0) {
					...
					if($situacion == 4){
					$salida.= "<td align = 'center'><a href = '../CP_INM1/Frm_my.php?eva=".$eva_id."&sit=5' onclick = '' type = 'button' class='btn btn-info' title = 'Evalua SubJefe EMDN'><i class='icon-user'></i></a></td>";
					}else if($situacion == 11){
					$salida.= "<td align = 'center'><a href = '../CP_INM1/Frm_my.php?eva=".$eva_id."&sit=12' onclick = '' type = 'button' class='btn btn-info' title = 'Evalua SubJefe EMDN'><i class='icon-user'></i></a></td>";
					}
			...
			$salida.="<font size=2 color='red'>NO EXITEN OFICIALES A EVALUAR POR EL SUBJEFE DEL EMDN</font>";
		}
		return $salida;
	}
