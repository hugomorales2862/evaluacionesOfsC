		...
		if($result != ""){
			...
			foreach($result as $row){
				...
				if ($cont % 2 == 0) {
					...
					if($situacion == 7){
					$salida.= "<td align = 'center'><center><a href = '../CP_INM3/Frm_f2do.php?eva=".$eva_id."&sit=8' onclick = '' type = 'button' class='btn btn-success' title = 'Evaluador Final'><i class='icon-user'></i></a></td>";
