		...
		<div id="container" align='center'>
			<div class='row-fluid'>
				<div class = 'span12' align='center'>
					<font size=5><b>Evaluadores Finales</font><br> <font size=3>Oficiales del Comando</font> <br><br> PERIODO: <?php echo $comp_eva; ?></b></font>
				</div>
			</div><br><br>
<!--==============================================================================================================================================
...
==========================================================================================================================================-->
					<?php 
					echo tabla_inmediato(3,$dependencia,$comp_eva); 
					?>
				</form><br><br>
			</div>
		</div>
