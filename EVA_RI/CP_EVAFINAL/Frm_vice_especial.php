		...
		<div id="container" align='center'>
			<div class='row-fluid'>
				<div class = 'span12' align='center'>
					<font size=5><b>Evaluador Final <br><img id='b' alt="Brand" src="../img/finanzas.png"  style="max-width:50px; margin-top: -4px;">VICEMINISTRO DE LA DEFENSA NACIONAL</font><br> <font size=3>Oficiales Especiales</font>
				</div>
			</div><br><br>
<!--==============================================================================================================================================
...
==========================================================================================================================================-->
					<?php 
					echo tabla_vice_finca(3,$dependencia); 
					?>
				</form><br><br>
			</div>
		</div>
