...
xajax_Grabar_borrador(evaluacion,linea,destino,autoevaluado,inmediato,eva_final,codigo_arma1,codigo_grado1,empleo1,tiempo1,codigo_arma2,codigo_grado2,empleo2,tiempo2,codigo_arma3,codigo_grado3,empleo3,tiempo3,puesto_ant,dep,renglon,tipo_evaluacion);
			...
			alert("Debe ingresar el grado actual!!!");
			foco('codigo_grado1');
		}
	}
		...
		function CloseWindow(){
			window.location.assign("../CP_ULFIN/Frm_ul.php");
		}
	...
	<form accept-charset="UTF-8">
		...
		<div class='row-fluid'>
		<div class='span2'>
		<P class='pull-left'><smallint>AUTOEVALUACIONES</smallint></P>
		</div>
		<?php if($mes == 6 or $mes == 7 or $mes == 8 or $mes == 5 ){?>
			<div class='span2'>
				<input type = 'text' class='span12' name = 'evaluacion' id = 'evaluacion' value ='1 - <?php echo $annio; ?>' readonly></input> 
			</div>
		<?php }else if($mes == 10 or $mes == 11 or $mes == 12 or $mes == 1 or $mes == 2 ){?>
			<div class='span2'>
		...
		<input type='hidden' name='tipo_evaluacion' id='tipo_evaluacion' value='16'></input> <!--el TIPO 7 == borrador, 4 es autoevaluacion, 5 = inmediato, 6 = final-->
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td colspan='2'><center><strong><small>EMPLEO ACTUAL Y UNIDAD<br><br></small></strong><input type="text" id='empleo1' name='empleo1' class='span4' value='<?php echo $empleo; ?>' onkeyup='mayusculas(this);'></input></center></td>
			<td><center><strong><small>TIEMPO EN EL EMPLEO ACTUAL<br><br></small></strong><input type="text" id='tiempo1' name='tiempo1' class='span2' value='<?php echo $t_pue; ?>' onkeyup='mayusculas(this);'></input></small></strong></center></td>
			<td><center><strong><small>EMPLEO ANTERIOR<br><br></small></strong><input type="text" id='puesto_ant' name='puesto_ant' class='span3' value='<?php if ($puesto_ant != ""){ echo $puesto_ant; }else{ $puesto_ant = "DESCONOCIDO"; echo $puesto_ant;}?>' onkeyup='mayusculas(this);'></input></center></td>
			<td><center><strong><small>DESTINO ACTUAL<br><br></small></strong><input type="text" id='destino' name='destino' class='span2' value='<?php echo $dep_desc; ?>' onkeyup='mayusculas(this);'></input></center></td>
			</tr>
			<tr>
			<td colspan='5'><strong><small>PARTE II. EVALUADORES</small></strong></td>
			</tr>
			<tr>
			<td colspan='2'><center><strong><small>GRADO Y NOMBRE DEL EVALUADOR INMEDIATO</small></strong><br><?php echo utf8_encode($nombresub1); ?><input type='hidden' name='codigo_grado2' id='codigo_grado2' value='<?php echo $codigo_grado1sub; ?>'></input><input type='hidden' name='codigo_arma2' id='codigo_arma2' value='<?php echo $codigo_arma1sub; ?>'></input></center></td>
			<td><center><strong><small>CATALOGO</small></strong><br><?php echo $catalogo_sub; ?><input type="hidden" id='inmediato' onblur='trae_usuario(1);' name='inmediato' class='span2' placeholder='Catalogo...' maxlength='6' value='<?php echo $catalogo_sub; ?>' onkeypress="return justNumbers(event);"></input></center></td>
			<td><center><strong><small>EMPLEO</small></strong><br><?php echo $empleosub; ?><input type='hidden' class='span2' id='empleo2' placeholder='Empleo' value='<?php echo $empleosub; ?>' onkeyup='mayusculas(this);'></input></center></td>
			<td><center><strong><small>TIEMPO EN EL EMPLEO</small></strong><br><input type='text' class='span2' id='tiempo2' placeholder='Tiempo/Puesto' value='<?php echo $t_puesub; ?>' onkeyup='mayusculas(this);'></input></center></td>
			</tr>
			<tr>
			<td colspan='2'><center><strong><small>GRADO Y NOMBRE DEL EVALUADOR FINAL</small></strong><br><?php echo utf8_encode($nombre_jefe1); ?><input type='hidden' name='codigo_grado3' id='codigo_grado3' value='<?php echo $codigo_grado_jefe; ?>'></input><input type='hidden' name='codigo_arma3' id='codigo_arma3' value='<?php echo $codigo_arma_jefe; ?>'></input></center></td>
			<td><center><strong><small>CATALOGO</small></strong><br><?php echo $catalogo_jefe; ?><input type="hidden" id='eva_final' onblur='trae_usuario(2);' name='eva_final' class='span2' placeholder='Catalogo...' value='<?php echo $catalogo_jefe; ?>' maxlength='6' onkeypress="return justNumbers(event);"></input></center></td>
			<td><center><strong><small>EMPLEO</small></strong><br><?php echo $empleo_jefe; ?><input type='hidden' class='span2' id='empleo3' placeholder='Empleo' value='<?php echo $empleo_jefe; ?>' onkeyup='mayusculas(this);'></input></center></td>
			<td><center><strong><small>TIEMPO EN EL EMPLEO</small></strong><br><input type='text' class='span2' id='tiempo3' placeholder='Tiempo/Puesto' value='<?php echo $t_puesto_jefe; ?>' onkeyup='mayusculas(this);'></input></center></td>
			</tr>
		</table>
		</table><br><br>
		<div align="center">
