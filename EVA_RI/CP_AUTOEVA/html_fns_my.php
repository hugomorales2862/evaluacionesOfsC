		...
		if($result != ""){
			...
			foreach($result as $row){
				...
				if($situacion == 16){
					...
					$salida.= "<td align = 'center'><a href = '../CP_EVALUACION1/Frm_mia.php?eva=".$eva_id."&sit=17'  onclick = '' type = 'button' class='btn btn-info' title = 'Autoevaluar'><i class='icon-user'></i></a></td>";
