...
<html>
	<head>
		...
		function Grabar_formulario(){
			...
			var obs_final = document.getElementById('obs_inmediato').value;
	...
	<form accept-charset="UTF-8">
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td colspan='2'><center><strong><small>EMPLEO ACTUAL Y UNIDAD<br><br></small></strong><?php echo utf8_decode($emp1); ?></center></td>
			<td><center><strong><small>TIEMPO EN EL EMPLEO ACTUAL<br><br></small></strong><?php echo utf8_encode($tie1); ?></small></strong></center></td>
