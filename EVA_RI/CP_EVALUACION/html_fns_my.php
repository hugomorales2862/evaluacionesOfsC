		...
		if($result != ""){
			...
			foreach($result as $row){
				...
				if ($grado == 46 || $grado == 59 || $grado == 65 || $grado == 73 || $grado == 81 || $grado == 88 || $grado == 92 || $grado == 93 || $grado == 96 || $grado == 97 || $grado == 99 || $grado == 40){
					...
					$salida.="<td ><font size=2>".$nombre."</font></td>";
					$salida.= "<td align = 'center'><a href = '../CP_INM/Frm_mod.php?eva=".$eva_id."&sit=0' onclick = '' type = 'button' class='btn btn-default' title = 'Modificar borrador'><i class='icon-pencil'></i></a></td>";
					if($situacion==30){
						$salida.= "<td align = 'center'><a href = '../CP_EVALUACION/Frm_mia1.php?eva=".$eva_id."&sit=1'  onclick = '' type = 'button' class='btn btn-warning' title = 'Evaluar'><i class='icon-user'></i></a></td>";
					}elseif($situacion == 31){
						$salida.= "<td align = 'center'><a href = '../CP_EVALUACION/Frm_mia2.php?eva=".$eva_id."&sit=1'  onclick = '' type = 'button' class='btn btn-danger' title = 'Evaluar'><i class='icon-user'></i></a></td>";
					}else{
						$salida.= "<td align = 'center'><a href = '../CP_EVALUACION/Frm_mia.php?eva=".$eva_id."&sit=1'  onclick = '' type = 'button' class='btn btn-info' title = 'Evaluar'><i class='icon-user'></i></a></td>";
					}
