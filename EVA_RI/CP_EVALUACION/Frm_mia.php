...
<html>
	<head>
		...
		function CloseWindow(num){
			if(num == 1){
				window.location.assign("../CP_EVALUACION/Frm_auto.php");
			}else{
	...
	<form accept-charset="UTF-8">
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td><center><strong><small>CATALOGO:<br><br></small></strong><?php echo utf8_encode($usuario); ?></center></td>
			<td><center><strong><small>NOMBRES Y APELLIDOS:<br><br></small></strong><?php echo utf8_encode($nombre); ?></center></td>
			<td><center><strong><small>GRADO:<br><br></small></strong><?php echo utf8_encode($gra1); ?></center></td>
