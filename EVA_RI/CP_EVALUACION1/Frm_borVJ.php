...
<html>
	<head>
		...
		function Grabar_formulario(){
			...
			var eva_final = document.getElementById('inmediato').value;
			...
			var codigo_arma3 = document.getElementById('codigo_arma2').value;
			var codigo_grado3 = document.getElementById('codigo_grado2').value;
			var empleo3 = document.getElementById('empleo2').value;
			var tiempo3 = document.getElementById('tiempo2').value;
...
xajax_Grabar_borrador(evaluacion,linea,destino,autoevaluado,inmediato,eva_final,codigo_arma1,codigo_grado1,empleo1,tiempo1,codigo_arma2,codigo_grado2,empleo2,tiempo2,codigo_arma3,codigo_grado3,empleo3,tiempo3,puesto_ant,dep,renglon,tipo_evaluacion);
	...
	<form accept-charset="UTF-8">
		...
		<input type='hidden' name='tipo_evaluacion' id='tipo_evaluacion' value='20'></input> <!--el TIPO 14 borrador y 15 final-->
		...
		<table width='100%' border='1' >
			...
			<tr>
			<td colspan='2'><center><strong><small>GRADO Y NOMBRE DEL EVALUADOR FINAL</small></strong><br><input type='text' class='span2' id='nombre_inmediato' placeholder='Evaluador Final' readonly></input><?php echo combo_grados2(); ?><input type='hidden' name='codigo_arma2' id='codigo_arma2' value=''></input></center></td>
