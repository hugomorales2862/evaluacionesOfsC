...
<html>
	<head>
		...
		function Grabar_formulario(){
			...
			if(cod_eva != "") {
				...
				window.location.assign("../CP_UL1/Frm_ulDIR.php");
			}
		}
	...
	<form accept-charset="UTF-8">
		...
		<table width='100%' border='1' >
			...
			<td><center><input type="radio" name="pregunta17" id="prgunta17" value="0" disabled></center></td>
			</tr>
			<tr bgcolor="#E0FFFF">
			<td><center><strong><small>3.</small></strong></center></td>
			<td><b>RESPONSABILIDAD:</b><br>Capacidad para cumplir las tareas y responsabilidades inherentes al grado y funcion, con dedicacion, puntualidad y observando los plazos establecidos.</td>
			...
			<input type='hidden' class='form-control span12' name='obs_final' id='obs_final' rows='2' onkeyup='mayusculas(this);'  value='' placeholder='AGREGUE OBSERVACIONES' readonly></input>
			<input type='hidden' name='bol_desc_empleo' id='bol_desc_empleo' value="">
			</tr>
			<?php }else{ ?>
			<tr>
